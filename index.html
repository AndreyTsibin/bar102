...
<body class="body">
  ...
  <footer class="footer">
      ...
      <div class="contact-wrapper">
        ...
        <div class="contact">
          ...
          <div class="contact__item">
            ...
            <a class="contact__link" href="tel:+7904783200">+7 (904) 78 83 20</a>
          </div>
          <!-- Адрес -->
          <div class="contact__item">
            <p class="contact__title">Адрес:</p>
            <a class="contact__link" href="https://yandex.ru/maps/-/CCUHNJRCWA" target="_blank">Маяковского, 12а, Сургут
            </a>
          </div>
          <!-- Социальные сети -->
          <div class="contact__item">
            <p class="contact__title">Социальные сети:</p>
            <div class="header__social">
              <!-- Телеграм -->
              <a href="https://t.me/+79821946648" class="header__social-link" target="_blank">
                <svg class="header__social-link" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="contact__item">
            ...
            <div class="contact__item--time">
              <p class="contact__link">Пн </p><span class="contact__link">18:00 - 0:00</span>
            </div>

            <div class="contact__item--time">
              <p class="contact__link">Вт </p><span class="contact__link">18:00 - 0:00</span>
            </div>


            <div class="contact__item--time">
              <p class="contact__link">Ср </p><span class="contact__link">18:00 - 0:00</span>
            </div>


            <div class="contact__item--time">
              <p class="contact__link">Чт </p><span class="contact__link">18:00 - 0:00</span>
            </div>


            <div class="contact__item--time">
              <p class="contact__link">Пт </p><span class="contact__link">18:00 - 1:00</span>
            </div>


            <div class="contact__item--time">
              <p class="contact__link">Сб </p><span class="contact__link">18:00 - 1:00</span>
            </div>


            <div class="contact__item--time">
              <p class="contact__link">Вс </p><span class="contact__link">18:00 - 0:00</span>
            </div>
        ...
        <div class="map">
          <iframe class="map"
            src="https://yandex.ru/map-widget/v1/?um=constructor%3A1e80e89cf898f38958d6701e458ce5d8d22f3c42aa5ebe8da65fa100ad4b5f1c&amp;source=constructor"
    ...
    <div class="footer__copyright wrapper">
      <p class="copyright">© <span class="copyright" id="copyright">2022</span>. "102 dB" Все права защищены</p>
      <a href="https://andreytsibin.ru/" class="copyright__link" target="_blank">Designed by AC</a>
    </div>
  </footer>

  <!-- Скрипт открывает карточку афиши на весь экран -->
  <script>
    const clickableImages = document.querySelectorAll('.afisha__card-img');
    ...
    clickableImages.forEach(clickableImage => {
      clickableImage.addEventListener('click', () => {
        ...
        fullscreenImage.alt = clickableImage.alt;
        fullscreenImage.classList.add('fullscreen-image');

        fullscreenImage.addEventListener('click', () => {
          fullscreenImage.classList.remove('open');
          setTimeout(() => {
            imageContainer.removeChild(fullscreenImage);
          }, 300);
        });

        setTimeout(() => {
          fullscreenImage.classList.add('open');
        }, 0);
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      var target = document.querySelector('#afisha');
  ...
  <script>
    ...
    // Находим элемент с id "copyright"
    var copyrightElement = document.getElementById("copyright");

    // Проверяем, что элемент найден
    if (copyrightElement) {
      // Заменяем содержимое элемента на текущий год
